			...
			<?php if ( true === (bool) $license['activated'] ) : ?>
				<div class="themeum-license-alert-success">
					...
					<div class="themeum-license-alert-message">
						...
						echo esc_html( sprintf( __( 'Your %s is connected to the Themeum.com license system and will now receive automatic updates', 'tutor-pro' ), $product_title ) );
						?>
			...
			<div class="themeum-license-fieldset">
				<div class="themeum-license-fieldset-content">
					...
					<div class="themeum-license-help-text">
						...
						<a href="https://www.themeum.com/my-account/licenses"><?php esc_html_e( 'Get the license key', 'tutor-pro' ); ?></a>
					</div>
				</div>
			</div>
